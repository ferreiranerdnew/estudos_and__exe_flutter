    ...
    home: Scaffold(
      ...
      body: Center(child: Column(
        children: [
          ...
          Expanded(child: _ChartApp()), // O gráfico é expandido para preencher o restante do espaço disponível
        ],
      )),
    ),
  ));
...
SalesData(36.74)
    ...
    final double primeiroValor = chartData.isNotEmpty ? chartData.first.value : 0.0;
    final double ultimoValor = chartData.isNotEmpty ? chartData.last.value : 0.0;
